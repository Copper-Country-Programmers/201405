...
public class MLogo implements ActionListener {
	...
	private void initGUI(TurtleGraphics t){
		 try{ base = new URL("file:///C:/Users/Avion/Documents/GitHub/MLogo/docs/"); }
		...
		this.help.setText("Welcome to Loko v0.2! I will be your digital tutor. Type help for a list of commands.");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		this.display = listener.getText();
		insertText(">" + this.display, terminal);
		listener.setText("");
	}
	...
	private void primitiveIO(Environment e, boolean trace) {
		...
		e.bind(new LWord(LWord.Type.Prim, "help") {
			public void eval(Environment e) {
				java.util.List<LWord> words = new ArrayList<LWord>(e.words());
				Collections.sort(words);
				for(LWord word : words) { insertText("<html><a href=\"" + word + ".html\">" 
						+ word.toString() + "</a>", help); }
			}
		});
